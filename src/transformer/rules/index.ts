 ...
 * point of a fence being that sample code is not documentation to rewrite. Then
 * type braces are stripped and tags renamed before separators are inserted, and
 * structural line removals run last so earlier rules see the full comment.
 * `RULES` is frozen to keep the pipeline deterministic.
 *
 * @since 0.1.0
 */
